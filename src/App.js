...
const TinikoGuestHouse = () => {
  ...
  const rooms = [
    ...
    { id: 4, number: 4, floor: 2, capacity: 4, amenities: ['wifi', 'bathroom', 'balcony', 'aircon', 'tv', 'miniFridge'] },
    { id: 5, number: 5, floor: 2, capacity: 4, amenities: ['wifi', 'bathroom', 'balcony', 'aircon', 'tv', 'miniFridge', 'seaside'] },
    { id: 6, number: 6, floor: 2, capacity: 2, amenities: ['wifi', 'bathroom', 'balcony', 'aircon', 'tv', 'miniFridge', 'seaside'] } 
  ];
